#ifndef __CLP300_HW_H__
#define __CLP300_HW_H__


static const uint32_t PKA_BASE_ADDR = 0x60000000UL;
...
/**
* @brief define the base operand size
*/
enum {
    PKA_CTRL_BASE_RADIX_BIT_256 = 2,
    PKA_CTRL_BASE_RADIX_BIT_512,
    PKA_CTRL_BASE_RADIX_BIT_1024,
    PKA_CTRL_BASE_RADIX_BIT_2048,
    PKA_CTRL_BASE_RADIX_BIT_4096
};

enum {
    PKA_CTRL_PARTIAL_RADIX_ALU_32BIT    = 17,
    PKA_CTRL_PARTIAL_RADIX_ALU_64BIT    = 18,
    PKA_CTRL_PARTIAL_RADIX_ALU_128BIT   = 20
};
